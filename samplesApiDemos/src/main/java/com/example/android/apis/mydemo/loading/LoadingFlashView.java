package com.example.android.apis.mydemo.loading;
...
//        mAnimatorSet.playTogether(new Animator[]{loadAnimator1, loadAnimator2, loadAnimator3, loadAnimator4});
    ...
    public void setLoadingTheme(boolean isNight) {
        if (isNight) {
            PorterDuffColorFilter localPorterDuffColorFilter = new PorterDuffColorFilter(0XCC363636, PorterDuff.Mode.SRC_ATOP);
