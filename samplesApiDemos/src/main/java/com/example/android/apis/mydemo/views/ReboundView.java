...
public class ReboundView extends FrameLayout {
    ...
    public ReboundView(@NonNull Context context) {
        this(context, null);
    }

    public ReboundView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ReboundView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
