...
//    private Paint mPaint;
    ...
    public ButtonPathLoadingView(Context context) {
        this(context, null);
    }

    public ButtonPathLoadingView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ButtonPathLoadingView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//            canvas.drawCircle(mCricleCenterX + i * mPadding, mHeight / 2f, RADIUS, paint);
            }
        }
        canvas.restore();
    }
